...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["/", "/tools", "/watch-together", "/watch-together/supported", "/guides", "/status", "/changelog", "/connections", "/studio", "/about", "/privacy", "/terms", "/cookies", "/privacy-choices", "/security", "/sub-processors", "/open-source", "/copyright", "/accessibility"];
  ...
  return [
    ...routes.map((route) => makeEntry(route, route === "/" ? 1 : route === "/tools" || route === "/watch-together" ? .95 : route === "/guides" || route === "/status" || route === "/watch-together/supported" ? .85 : .65, route === "/" || route === "/tools" || route === "/watch-together" || route === "/changelog" ? "weekly" : "monthly")),

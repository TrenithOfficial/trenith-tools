...
export default function StatusPage() {
  return <>
    ...
    <section className="status-section page-frame">
      <article className="watch-status-card"><div><span className="status-dot" /><strong>Watch Together beta</strong><p>Room, encrypted chat/reactions, WebRTC voice/video and the cross-browser companion are implemented. Launch provider adapters: YouTube, Netflix, Prime Video and JioHotstar. Other OTT websites use the documented generic HTML5 beta.</p></div><div><span>25 sync</span><span>6 media</span><span>6h expiry</span><Link href="/watch-together/supported">Compatibility →</Link></div></article>

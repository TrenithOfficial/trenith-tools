...
export default function CookiesPage() { return <LegalPage title="Cookies only after a real choice." summary="Effective 18 July 2026">
  ...
  <h2>Necessary</h2><p>Stores your consent record, security state and short-lived interface session information. Session BYOK credentials are kept in session storage at your direction; an optional encrypted vault is kept in local storage until you delete it. Watch Together stores the current room token and invitation material in session storage so a refresh can recover the room; it is removed when you leave/end the room or close the browser session. The companion extension stores only its version and current connected-tab identifier. These functions cannot be disabled through our banner because the requested feature would not work.</p>
